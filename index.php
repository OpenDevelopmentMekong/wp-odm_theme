 ...
 <?php
  $options = get_option('opendev_options');
   ...
   $intro_texts = opendev_get_intro_texts();
    if (!empty($intro_texts)) :c
   ?>
   <section id="site-intro" <?php $options_msg = get_option('opendev_options');
    if (!empty($options_msg['notice_message'])): echo "style='margin-top:1em'";
    endif;
    ?>>
    <div class="container">
        ...
        <div class="text-item">
         <div class="icon">
          <?php if ($intro_texts[1]['icon']) : ?>
           <p class="icon-<?php echo $intro_texts[1]['icon'];
    ?>"></p>
          <?php endif;
    ?>
         </div>
        ...
        <div class="text-item">
         <div class="icon">
          <?php if ($intro_texts[2]['icon']) : ?>
           <p class="icon-<?php echo $intro_texts[2]['icon'];
    ?>"></p>
          <?php endif;
    ?>
         </div>
         <div class="content">
          ...
          <h3><?php echo $intro_texts[2]['title'];
    ?></h3>
          <p><?php echo $intro_texts[2]['content'];
    ?></p>
         </div>
        </div>
       </div>
        ...
        <div class="text-item">
         <div class="icon">
          <?php if ($intro_texts[3]['icon']) : ?>
           <p class="icon-<?php echo $intro_texts[3]['icon'];
    ?>"></p>
          <?php endif;
    ?>
         </div>
         <div class="content">
          <h3><?php echo $intro_texts[3]['title'];
    ?></h3>
          <p><?php echo $intro_texts[3]['content'];
    ?></p>
         </div>
        </div>
       </div>

...
<script type="text/javascript">
  ...
  function drawChart() 
  {
    ...
    var data_1973 = google.visualization.arrayToDataTable([
    	...
    	['Mondul Kiri',1228871.94,827697.07,401174.86],
    	['Ratanak Kiri',1116499.13,783735.99,332763.14],
    ...
    var data_1989 = google.visualization.arrayToDataTable([
    	...
    	['Mondul Kiri',1225129.50,806366.77,418762.73],
    	['Ratanak Kiri',1108012.06,719138.53,388873.53],
    ...
    var data_2000 = google.visualization.arrayToDataTable([
    	...
    	['Mondul Kiri',1228260.09,743688.63,484571.46],
    	['Ratanak Kiri',1096391.16,653885.03,442506.13],
  ...
  <!-- 2004---------------------------------------------------------->  
    var data_2004 = google.visualization.arrayToDataTable([
    	...
    	['Mondul Kiri',1213981.29,724789.59,489191.71],
    	['Ratanak Kiri',1019881.64,635814.02,384067.61],
    ...
    var data_2009 = google.visualization.arrayToDataTable([
    	...
    	['Mondul Kiri',1074626,220836.48,853789.11],
    	['Ratanak Kiri',1014534,387122.69,627411.02],
    ...
    var data_2013 = google.visualization.arrayToDataTable([
    	['Province',	'Total Forest', 'Dense Forest', 'Mixed Forest'],
    	['Koh Kong',814235,591683.11,222551.68],
    	['Mondul Kiri',908579,145953.68,762624.84],
    	['Ratanak Kiri',550836,136555.60,414280.55],
    	['Stung Treng',735232,139458.48,595773.77],
    	['Pursat',725124,271958.70,453165.79],
    	['Kratie',655976,100252.20,555723.53],
    	['Kampong Thom',608940,220420.13,388520.09],
    	['Preah Vihear',1060513,95469.14,965043.62],
    	['Battambang',470496,48020.06,422476.19],
    	['Siem Reap',317988,11406.42,306581.82],
    	['Oddar Meanchey',242467,7621.95,234844.73],
    	['Kampong Cham',403689,28192.63,375496.48],
    	['Kampot',119845,54476.65,65368.61],
    	['Preah Sihanouk',113280,41938.97,71341.07],
    	['Kampong Speu',262143,44228.39,217914.88],
    	['Pailin',66492,6915.43,59576.34],
    	['Banteay Meanchey',51612,344.62,51266.94],
    	['Kampong Chhnang',131138,9228.79,121909.13],
    	['Svay Rieng',4138,0.00,4138.45],
    	['Takeo',27387,10794.94,16591.89],
    	['Prey Veng',31382,419.78,30962.31],
    	['Kep',859,580.97,278.38],
    	['Kandal',87323,749.46,86573.55],
    	['Phnom Penh',7562,238,7324]
    ]);
    ...
    var per_data_1973 = google.visualization.arrayToDataTable([
    	...
    	['Mondul Kiri',6.77,4.56,2.21],
    	['Ratanak Kiri',6.15,4.32,1.83],
    ...
    var per_data_1989 = google.visualization.arrayToDataTable([
    	...
    	['Mondul Kiri',6.75,4.44,2.31],
    	['Ratanak Kiri',6.10,3.96,2.14],
    ...
    var per_data_2000 = google.visualization.arrayToDataTable([
    	...
    	['Mondul Kiri',6.76,4.10,2.67],
    	['Ratanak Kiri',6.04,3.60,2.44],
    ...
    var per_data_2004 = google.visualization.arrayToDataTable([
    	...
    	['Mondul Kiri',6.68,3.99,2.69],
    	['Ratanak Kiri',5.62,3.50,2.11],
    ...
    var per_data_2009 = google.visualization.arrayToDataTable([
    	...
    	['Mondul Kiri',5.92,1.22,4.70],
    	['Ratanak Kiri',5.59,2.13,3.45],
    ...
    var per_data_2013 = google.visualization.arrayToDataTable([
    	['Province',	'Total Forest', 'Dense Forest', 'Mixed Forest'],
    	['Koh Kong',4.48,3.26,1.23],
    	['Mondul Kiri',5.00,0.80,4.20],
    	['Ratanak Kiri',3.03,0.75,2.28],
    	['Stung Treng',4.05,0.77,3.28],
    	['Pursat',3.99,1.50,2.50],
    	['Kratie',3.61,0.55,3.06],
    	['Kampong Thom',3.35,1.21,2.14],
    	['Preah Vihear',5.84,0.53,5.31],
    	['Battambang',2.59,0.26,2.33],
    	['Siem Reap',1.75,0.06,1.69],
    	['Oddar Meanchey',1.34,0.04,1.29],
    	['Kampong Cham',2.22,0.16,2.07],
    	['Kampot',0.66,0.30,0.36],
    	['Preah Sihanouk',0.62,0.23,0.39],
    	['Kampong Speu',1.44,0.24,1.20],
    	['Pailin',0.37,0.04,0.33],
    	['Banteay Meanchey',0.28,0.00,0.28],
    	['Kampong Chhnang',0.72,0.05,0.67],
    	['Svay Rieng',0.02,0.00,0.02],
    	['Takeo',0.15,0.06,0.09],
    	['Prey Veng',0.17,0.00,0.17],
    	['Kep',0.00,0.00,0.00],
    	['Kandal',0.48,0.00,0.48],
    	['Phnom Penh',0.04,0.00,0.04],
    ]);

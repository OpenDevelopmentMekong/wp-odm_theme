		...
		<form class="advanced-nav-filters row <?php if($_GET[$this->prefix]) echo 'active'; ?>">
			...
			<div class="three columns alpha">
				<div class="search-input adv-nav-input">
					...
					<input type="text" id="<?php echo $this->prefix; ?>s" name="<?php echo $this->prefix; ?>s" placeholder="<?php _e('Type your search here', 'opendev'); ?>" value="<?php echo (isset($_GET[$this->prefix . 's'])) ? $_GET[$this->prefix . 's'] : ''; ?>" />
				</div>
			</div>
			<?php

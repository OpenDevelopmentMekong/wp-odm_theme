(function($) {
 ...
 $(document).ready(function() {
  ...
  $('#baselayer_drop_down').change(updateBaseLayerURLBox_opendev);
 ...
 function updateBaseLayerURLBox_opendev() {
  base_layer_url_box = $('#baselayer_url_box');

  switch ( $('#baselayer_drop_down').val() ){
   case 'openstreetmap':
    base_layer_url_box.val('https://a.tile.openstreetmap.org/{z}/{x}/{y}.png');
    base_layer_url_box.attr('readonly', true);
    break;
      case 'mapquest_osm':
       base_layer_url_box.val('https://otile1-s.mqcdn.com/tiles/1.0.0/map/{z}/{x}/{y}.jpg');
       base_layer_url_box.attr('readonly', true);
       break;
      case 'mapquest_sat':
       base_layer_url_box.val('https://otile1-s.mqcdn.com/tiles/1.0.0/sat/{z}/{x}/{y}.jpg');
       base_layer_url_box.attr('readonly', true);
       break;
      case 'stamen_toner':
       base_layer_url_box.val('https://stamen-tiles-{s}.a.ssl.fastly.net/toner-lite/{z}/{x}/{y}.png');
       base_layer_url_box.attr('readonly', true);
       break;
      case 'stamen_watercolor':
       base_layer_url_box.val('https://stamen-tiles-{s}.a.ssl.fastly.net/watercolor/{z}/{x}/{y}.jpg');
       base_layer_url_box.attr('readonly', true);
       break;
      case 'stamen_terrain':

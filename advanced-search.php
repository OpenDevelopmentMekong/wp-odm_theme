							...
							foreach ($resultset as $document):
								...
								<div id="solr_results">
									<div class="solr_result">
										...
										<p><?php if (is_array($document->odm_language)) echo "<b>language</b>: " . implode(", ",$document->odm_language)  ?> <?php if (is_array($document->categories)) echo "<b>topics</b>: " . implode(", ",$document->categories) ?></p>
									</div>
								</div>

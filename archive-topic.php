      ...
      <div class="sixteen columns">
        ...
        <?php
				...
				<?php
					...
					$post = get_post();
					$post_categories = get_categories_array($post);
						if (count(array_intersect($post_categories,$taxonomy_categories_2)) > 0):
							odm_get_template('post-grid-single-4-cols',array(
		  					"post" => $post,
		  					"show_meta" => true),true);
						endif;
				...
				<?php
					while (have_posts()) : the_post();
						$post = get_post();
						$post_categories = get_categories_array($post);
						if (count(array_intersect($post_categories,$taxonomy_categories_3)) > 0):
							odm_get_template('post-grid-single-4-cols',array(
		  					"post" => $post,
		  					"show_meta" => true),true);
						endif;

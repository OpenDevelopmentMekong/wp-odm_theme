  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="four columns">
  			<p><?php printf(__('This website is built on <a href="%s" target="_blank" rel="external">WordPress</a> using the <a href="%s" target="_blank" rel="external">JEO Beta</a> theme', 'odi'), 'http://wordpress.org', 'https://github.com/oeco/jeo'); ?></p>
  		</div>
			<?php
